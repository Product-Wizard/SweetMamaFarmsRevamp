...
const stats = [
  { value: "500+", label: "Farmers Partnered", desc: "Across local communities" },
  { value: "10+", label: "Years Experience", desc: "In commercial agriculture" },
  { value: "20+", label: "Product Lines", desc: "From grains to dairy" },
  { value: "6", label: "States Reached", desc: "Growing nationwide" },
];
